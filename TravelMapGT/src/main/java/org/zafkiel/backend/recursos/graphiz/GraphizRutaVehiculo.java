...
import static org.zafkiel.frontend.HomePage.colorearRutaVehiculo;

public class GraphizRutaVehiculo {
    ...
    public void generarArchivoDOT() {
        String ciudades = "";
        String dobleCirculo = new String(HomePage.colorearRutaVehiculo);
        ...
        String contenidoDOT = "digraph  rutas_completas {\n" +
        ...
        try {
            ...
            FileWriter writer = new FileWriter("graphvizRutasVehiculo.dot");
            writer.write(contenidoDOT);
            writer.close();
            System.out.println("Archivo DOT graphvizRutasVehiculo.dot generado correctamente.");
        } catch (IOException e) {
    ...
    public void generarImagenDesdeDOT() {
        try {
            ...
            ProcessBuilder processBuilder = new ProcessBuilder("dot", "-Tpng", "graphvizRutasVehiculo.dot", "-o", "graphvizRutasVehiculo.png");
            Process process = processBuilder.start();
            int exitCode = process.waitFor();
            if (exitCode == 0) {
                System.out.println("Imagen graphvizRutasVehiculo.png generada correctamente.");
            } else {
